...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 10, 2018 at 06:01 AM
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `user_first` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user_lastlogin` datetime DEFAULT CURRENT_TIMESTAMP,
  `user_attempts` time DEFAULT NULL,
  `user_lvl` varchar(250) NOT NULL,
  `user_verify` varchar(12) NOT NULL,
  `user_ip` varchar(50) NOT NULL DEFAULT 'no',
  `user_new_password` varchar(80) NOT NULL,
  `user_confirm_password` varchar(80) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_first`, `user_lastlogin`, `user_attempts`, `user_lvl`, `user_verify`, `user_ip`, `user_new_password`, `user_confirm_password`) VALUES
(1, 'Karlee2323', 'kar', 'password', 'kar23@gmail.com', '2018-02-08 21:01:36', '2018-03-09 19:38:43', '2018-02-15 20:50:06', '00:00:00', '1', 'yes', '::1', '', ''),
(3, 'Tester', 'test', 'test', 'testme@gmail.com', '2018-02-19 23:12:23', '2018-03-09 19:38:43', '2018-03-10 18:12:23', '00:00:03', '2', '', '::1', '', '');
COMMIT;
